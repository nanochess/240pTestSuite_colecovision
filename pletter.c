...
** XL2S Entertainment
**
** Es un compresor tipo LZ77, la compresi—n por bits puede ser lenta
** comparada con RLE (especialmente si se descompacta directo a VRAM porque
** tiene que leer el VRAM), pero siempre le va a ganar en reducci—n de
** espacio.
**
** Revisión: 19-abr-2011. Convertido a C por Oscar Toledo G.
*/
